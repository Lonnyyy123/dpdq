...
configs = [
    ...
    #Config("numFlow", ["TCP_FLOW_TOTAL", "NUM_BG_FLOWS"], int, 100),  # number of background flows.
    ...
    #Config("ratioFgFlow", "FOREGROUND_RATIO", float, 0.0),
...
if __name__ == '__main__':
    ...
    sim_bin = os.environ.get("SIM_BIN", os.path.join(os.curdir, "build/scratch/cb-simulator"))
    cmdline = [sim_bin, script_path]
