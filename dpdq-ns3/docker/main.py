...
configs = [
    ...
    Config("linkLoad", "LOAD", float, 0.05),
...
if __name__ == '__main__':
    ...
    cmdline = [os.path.join(os.curdir,"build/scratch/cb-simulator"), script_path]
    # Stream child output directly to parent stdout/stderr so long runs do not
    # buffer large logs in memory (which can starve the host).
    proc = subprocess.Popen(cmdline, env=my_env)
