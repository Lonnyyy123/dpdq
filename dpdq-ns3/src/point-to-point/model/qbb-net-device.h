...
public:
  ...
  typedef Callback<int, Ptr<RdmaQueuePairGroup>, bool*, uint32_t, uint32_t> RdmaGetNextCreditBouncerQindex;
  RdmaGetNextCreditBouncerQindex m_rdmaGetNextCreditBouncerQindex;
...
public:
  ...
  bool Attach (Ptr<QbbChannel> ch);
   ...
   TracedCallback<uint32_t, uint32_t, uint32_t> m_tracePfcState; // ifIndex, qIndex, 0: resume, 1: pause
 protected:
