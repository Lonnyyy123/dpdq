...
RdmaQueuePair::RdmaQueuePair(uint16_t pg, Ipv4Address _sip, Ipv4Address _dip, uint16_t _sport, uint16_t _dport){
	...
	mlx.m_rpTimeStage = 0;
	mlx.m_rpByteStage = 0;
	mlx.m_rpByteCounterBytes = 0;
	mlx.m_rpByteResetBytes = 0;
	...
	cb.m_enabled = false;
	cb.m_classificationReady = false;
	cb.m_hasScheduledPart = false;
	cb.m_schedRequestAnnounced = false;
	cb.m_pendingScheduledBytes = 0;
	cb.m_unsolicitedBytesBudget = 0;
	cb.m_unsolicitedBytesSent = 0;
	cb.m_standaloneGrantReqSent = false;
	cb.m_usnsolCheckDone = false;
	cb.m_isScheduled = true;
	cb.m_sentAnnouncement = false;
	cb.m_selfAllocCreditBytes = 0;
	cb.m_selfAllocCreditDataBytes = 0;
	cb.m_remainingSelfAllocCreditDataBytes = 0;
	cb.m_statCreditReqPkts = 0;
	cb.m_statCreditGrantPkts = 0;
	cb.m_statScheduledDataPkts = 0;
	cb.m_statUnsolicitedDataPkts = 0;
	cb.m_statUnscheduledDataPkts = 0;
	cb.m_statCsnMarkedPkts = 0;
	cb.m_priorityFlowPending = false;
...
RdmaRxQueuePair::RdmaRxQueuePair(){
	...
	cb.m_enabled = false;
	cb.m_pendingDemandBytes = 0;
	cb.m_announcementAccounted = false;
	cb.m_announcementExpectedBytes = 0;
	cb.m_receivedDataBytes = 0;
	cb.m_completionNotified = false;
	cb.m_expectedChunks = 0;
	cb.m_receivedChunks = 0;
	cb.m_grantedChunkLimit = 0;
	cb.m_receivedChunkBitmap.clear();
}
