...
client_injection_rate_gbps_list="25"
duration_modifier_l="0.002"
mean_req_size_B_l='2927.354'
req_size_distr='w3'
general_queue_size_l='4'
...
r2p2_resend_timeout_s_l='0.00004'

ppass_pthresh_l='2685'
ppass_rho_l='1'
ppass_egress_queue_thresh_bytes_l='512'
dpdq_xoff_bytes_l='3800'
dpdq_xon_bytes_l='3750'
