...
client_injection_rate_gbps_list="6.0" # host<->tor load=0.9
duration_modifier_l="0.017"
mean_req_size_B_l='500000'
req_size_distr='w3'
...
dpdq_xoff_bytes_l='141500'
dpdq_xon_bytes_l='138500'
...
simulation_name_l='dpdq-ls-w3-fgata0.004h20kb-srpt'
